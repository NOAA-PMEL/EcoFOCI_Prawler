"""
 ...
 2018 St Matt Prawler Mooring Realtime Data parsing and archiving.
...
if args.met_rudix:
    ...
    kid = KetchMetData.get_data(datetime.datetime(2018,4,30),server=args.ServerName,platform='ber0')
...
if args.image:
    ...
    plt.savefig('2018_MTITAE_prawler_image.svg', bbox_inches='tight', dpi = (300))
    plt.savefig('2018_MTITAE_prawler_image.png', bbox_inches='tight', dpi = (300))
    plt.close()

...
"""
 ...
 class for building netcdf files from specified instruments
  ...
  History:
 --------
 2018-09-13: Tweak to be python3 compliant
...
class NetCDF_Create_Timeseries(object):
    ...
    def variable_init(self, EPIC_VARS_dict, udunits_time_str='days since 1900-1-1', verbose=False ):
        """
        EPIC keys:
